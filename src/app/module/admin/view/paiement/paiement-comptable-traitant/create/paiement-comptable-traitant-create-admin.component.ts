...
@Component({
  selector: 'app-paiement-comptable-traitant-create-admin',
  templateUrl: './paiement-comptable-traitant-create-admin.component.html'
})
export class PaiementComptableTraitantCreateAdminComponent extends AbstractCreateController<PaiementComptableTraitantDto, PaiementComptableTraitantCriteria, PaiementComptableTraitantAdminService>  implements OnInit {
