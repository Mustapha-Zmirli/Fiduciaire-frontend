...
@Component({
  selector: 'app-paiement-comptable-validateur-edit-admin',
  templateUrl: './paiement-comptable-validateur-edit-admin.component.html'
})
export class PaiementComptableValidateurEditAdminComponent extends AbstractEditController<PaiementComptableValidateurDto, PaiementComptableValidateurCriteria, PaiementComptableValidateurAdminService>   implements OnInit {
    ...
    public override prepareEdit() {
        this.item.datePaiement = this.paiementComptableValidateurService.format(this.item.datePaiement);
    }
