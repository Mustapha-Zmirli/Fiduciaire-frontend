...
@Component({
  selector: 'app-categorie-piece-joint-edit-admin',
  templateUrl: './categorie-piece-joint-edit-admin.component.html'
})
export class CategoriePieceJointEditAdminComponent extends AbstractEditController<CategoriePieceJointDto, CategoriePieceJointCriteria, CategoriePieceJointAdminService>   implements OnInit {
