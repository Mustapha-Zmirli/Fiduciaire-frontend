...
export class EtatDemandeEditAdminComponent extends AbstractEditController<EtatDemandeDto, EtatDemandeCriteria, EtatDemandeAdminService>   implements OnInit {
