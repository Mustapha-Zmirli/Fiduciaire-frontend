...
@Component({
  selector: 'app-type-demande-edit-admin',
  templateUrl: './type-demande-edit-admin.component.html'
})
export class TypeDemandeEditAdminComponent extends AbstractEditController<TypeDemandeDto, TypeDemandeCriteria, TypeDemandeAdminService>   implements OnInit {
