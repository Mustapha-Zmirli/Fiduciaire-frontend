...
@Component({
  selector: 'app-demande-piece-joint-create-admin',
  templateUrl: './demande-piece-joint-create-admin.component.html'
})
export class DemandePieceJointCreateAdminComponent extends AbstractCreateController<DemandePieceJointDto, DemandePieceJointCriteria, DemandePieceJointAdminService>  implements OnInit {
